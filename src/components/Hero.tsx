...
const socialLinks = [
  { icon: <Github size={20} />, href: "https://github.com/sayed725" },
  { icon: <Linkedin size={20} />, href: "https://www.linkedin.com/in/abu-sayed-khan-922801317?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: <Facebook size={20} />, href: "https://www.facebook.com/abu.sayed.khan.725" },
  {
    icon: (
      <svg
        viewBox="0 0 24 24"
