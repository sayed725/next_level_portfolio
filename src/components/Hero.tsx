...
export default function Hero() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-5 lg:pb-0 px-4 sm:px-6 overflow-hidden">
      ...
      <section className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-lg items-center relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start gap-4 lg:gap-md text-center lg:text-left">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button size={"lg"} variant="outline" className="px-6 sm:px-8 py-5 sm:py-6 rounded-md text-sm sm:text-base font-semibold glass-card border-white/10 text-white hover:bg-white/5 transition-all">
                <FileText className="" />
                Download Resume
              </Button>
            </motion.div>
